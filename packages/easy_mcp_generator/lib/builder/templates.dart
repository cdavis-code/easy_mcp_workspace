...
import 'package:easy_mcp_generator/builder/schema_builder.dart';
...
class StdioTemplate {
  ...
  static String generate(List<Map<String, dynamic>> tools) {
...
/// the default loopback address (127.0.0.1) is specified, avoiding unused
/// import warnings for custom addresses.
///
